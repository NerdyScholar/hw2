...
-------------------+-----------------------+-----------------------+----------------------
                28 |                     1 |               1404961 |                  385
```
Мы видим, что не все контрольные точки создались по расписанию. Это связано с блокировками, которые могли быть во время попытки сделать новую контрольную точку.
...
```
Данные прочитались, так как мы тронули только заголовки. С помошью прописанного параметра нам удалось прочитать таблицу. При этом мы берем во внимание, что данные без схождения контрольных сумм могут быть повреждены и некорректны.
